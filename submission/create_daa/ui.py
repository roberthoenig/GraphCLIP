...
# Paths to the visual genome directories.
IMAGE_DIR1 = "datasets/visual_genome/raw/VG_100K"
IMAGE_DIR2 = "datasets/visual_genome/raw/VG_100K_2"
# Path to the output from prefilter.py
DATASET_INPUT_PATH = "daa.json"
# Where to store the user-selected samples.
DATASET_OUTPUT_PATH = "daa_user_selected.json"
# Whether or not to only include samples that are hard for the histogram. 
FILTER_BY_is_adv_more_likely = False
...
# Checks if a histogram classifier would prefer the adversarial prompt
# over the original prompt.
